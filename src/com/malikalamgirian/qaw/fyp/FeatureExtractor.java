...
//             Select "PosFiltered Strings"
            ...
            for (int i = 0; i < pairs_Of_UnProcessed_Doc.getLength(); i++) {
                 ...
                 * test
                 */
                System.out.println("Swr1 : " + PosFilteredString1Str + " :: Swr2 : " + PosFilteredString2Str + "\n");

                /*
                 * Create Node for CosineSimilarityTokSwr
                 */
                CosineSimilarityPrep_Element = unProcessed_Doc.createElement("CosineSimilarityPrep");

                /*
                 * Calculate Raw Similarity
                 * using Standard similarity metrics
                 */
                 CosineSimilarityPrep_Element.setTextContent(Float.toString((new CosineSimilarity()).getSimilarity(PosFilteredString1Str, PosFilteredString2Str)));
                 
                 /*
                  * Add pair
                  */
                pair_UnProcessed.appendChild(CosineSimilarityPrep_Element);
    ...
    private void setFeature_Extracted_File_URL(Properties properties) throws Exception {
        ...
        try {
             ...
             */
            suffixToAdd = "cos_sim_prep_features_extracted";
