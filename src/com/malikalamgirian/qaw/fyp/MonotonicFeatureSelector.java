...
public class MonotonicFeatureSelector {
    ...
    private void process() throws Exception {
        ...
        NodeList pairs,
                ...
                String1_NodeList,
                String2_NodeList,
                TaggedString1_NodeList,
                TaggedString2_NodeList,
                LBALSequenceForString1_NodeList,
                LBALSequenceForString2_NodeList,
                CosineSimilarityPrep_NodeList,
...
//             Get the required one
            CosineSimilarityPrep_NodeList = root.getElementsByTagName("CosineSimilarityPrep");
            ...
            for (int i = 0; i < pairs.getLength(); i++) {
                ...
                /*
                 * Extract CosineSimilarityPrep value
                 */
                CosineSimilarityPrep_String = CosineSimilarityPrep_NodeList.item(i).getTextContent();
                ...
                if (i == 0) {
                     ...
                     * 
                     *
                     * String1Id,String2Id,CosineSimilarityPrep,pair_Quality
                     */
                    line_To_Insert_In_File = "String1Id,"
                            + "String2Id,"
                            + "CosineSimilarityPrep,"
                            + "pair_Quality";
                ...
                /*
                 * Cosine Similarity ... CosineSimilarityPrep
                 */
                line_To_Insert_In_File = appendString(line_To_Insert_In_File, CosineSimilarityPrep_String, feature_Separator_Char);
